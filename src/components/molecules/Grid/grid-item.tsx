...
import { BreakpointsValue, Justify, Direction, AlignItems, AlignContent } from "utils/props-types";
...
export type GridItemProps = Props & Partial<typeof defaultProps> & NativeAttrs & GridItemVariantProps;
...
const GridItem = React.forwardRef<HTMLDivElement, React.PropsWithChildren<GridItemProps>>(
  (
    ...
    return (
      <StyledGridItem
        ref={ref}
        className={clsx("grid-item", classes, className)}
        css={{
          alignItems,
          alignContent,
